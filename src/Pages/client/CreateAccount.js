...
import { sendOtp } from "../../Pagesactions/usersactions";
...
function CreateAccount(props) {
  ...
  const createAccount = window.location.href.includes("createAccount");
          ...
          >
            ...
            {window.location.href.includes("createAccount") ? (
              <Typography variant="body2">
                <Link style={{ color: "rgb(216, 68, 30)" }} to="/client/login">
                  Register Here
                </Link>
              </Typography>
            ) : (
