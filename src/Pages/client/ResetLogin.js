...
import { verifyOtp } from "../../Pagesactions/usersactions";
      ...
      >
        <Grid item>
          ...
          {window.location.href.includes("reset") ? (
            ...
            >
              To ensure your account , please complete the following
              verifications
            </Typography>
          )}
        </Grid>
            ...
            <form>
              {window.location.href.includes("reset") ? (
                ...
                <>
                  ...
                  >
                    Enter the 4 digit code recieved on 316****106
                  </Typography>
                </>
              )}
              {window.location.href.includes("reset") ? (
                <Button
                  ...
                  variant="contained"
                  color="secondary"
                  style={{ borderRadius: 20, width: "50%", marginTop: "4%" }}
